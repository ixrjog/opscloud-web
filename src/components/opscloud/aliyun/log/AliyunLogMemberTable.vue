  ...
  <div v-show="queryParam.logId !== ''">
    ...
    <el-table :data="tableData" style="width: 100%" v-loading="loading">
      ...
      <el-table-column fixed="right" label="操作" width="240">
        <template slot-scope="scope">
          <el-button @click="handlerRowPush(scope.row)" type="primary" plain size="mini" style="margin-left: 5px">推送
          </el-button>
...
// API
import {
  queryAliyunLogMemberPage,
  removeAliyunLogMemberById,
  pushAliyunLogMemberById
} from '@api/cloud/aliyun.log.member.js'
import { pushAliyunLogById } from '@api/cloud/aliyun.log.js'
import AliyunLogMemberDialog from '@/components/opscloud/aliyun/log/AliyunLogMemberDialog'
